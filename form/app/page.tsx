...
export default function Home() {
  ...
  const subscriptionTiers = [
    { id: "foundation", label: "Foundation", price: "$1/month", value: 1 },
    { id: "builder", label: "Builder", price: "$1/month", value: 1 },
    { id: "flagship", label: "Flagship", price: "$1/month", value: 1 },
  ]

  const addOnOptions = [
    { id: "job-event", label: "Boost a Job or Event", price: "$1", value: 1 },
    { id: "virtual-hiring", label: "Virtual Hiring Event", price: "$1", value: 1 },
    { id: "hiring-event", label: "In-Person Hiring Event", price: "$1", value: 1 },
    { id: "network-sponsorship", label: "Sponsor a Networking Event", price: "$1", value: 1 },
  ]
